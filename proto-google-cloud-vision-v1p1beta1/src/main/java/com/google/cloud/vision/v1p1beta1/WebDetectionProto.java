  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ction.proto\022\035google.cloud.vision.v1p1beta1\032\034google/api/annotations.proto\"\214\007\n"
          + "\014WebDetection\022K\n"
          + "\014web_entities\030\001 \003(\01325.google"
          + ".cloud.vision.v1p1beta1.WebDetection.WebEntity\022R\n"
          + "\024full_matching_images\030\002 \003(\01324.g"
          + "oogle.cloud.vision.v1p1beta1.WebDetection.WebImage\022U\n"
          ...
          + " \003(\01324.google.cloud.vision.v1p1beta1.WebDetection.WebImage\022O\n"
          + "\021best_guess_labels\030\010"
          + " \003(\01324.google.cloud.vision.v1p1beta1.WebDetection.WebLabel\032B\n"
          + "\tWebEntity\022\021\n"
          ...
          + "e.cloud.vision.v1p1beta1.WebDetection.WebImage\022U\n"
          + "\027partial_matching_images\030\005 \003(\0132"
          + "4.google.cloud.vision.v1p1beta1.WebDetection.WebImage\0320\n"
          + "\010WebLabel\022\r\n"
          + "\005label\030\001 \001(\t\022\025\n\r"
          + "language_code\030\002 \001(\tB\200\001\n"
          + "!com.google.cloud.vision.v1p1beta1B\021WebDetectionProto"
          + "P\001ZCgoogle.golang.org/genproto/googleapi"
          + "s/cloud/vision/v1p1beta1;vision\370\001\001b\006proto3"
    };
    descriptor =
