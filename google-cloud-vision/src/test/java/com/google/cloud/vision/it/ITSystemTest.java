...
public class ITSystemTest {
  ...
  private static final GCS_BUCKET;
  ...
  private static final String SAMPLE_BUCKET = String.format("gs://%s/vision/", GCS_BUCKET);
  private static final String SAMPLE_URI =
      String.format("https://storage-download.googleapis.com/%s/vision/", GCS_BUCKET);
