...
```Groovy
implementation 'com.google.cloud:google-cloud-vision:2.0.10'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-vision" % "2.0.10"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-vision/tree/master/samples) directory.
