        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              requests_ = new java.util.ArrayList<com.google.cloud.vision.v1p4beta1.AnnotateFileRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            requests_.add(
                input.readMessage(com.google.cloud.vision.v1p4beta1.AnnotateFileRequest.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesRequest) e.getUnfinishedMessage();
