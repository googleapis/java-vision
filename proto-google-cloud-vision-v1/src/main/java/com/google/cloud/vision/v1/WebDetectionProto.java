  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "roto\022\026google.cloud.vision.v1\032\034google/api/annotations.proto\"\324\006\n"
          + "\014WebDetection\022D\n"
          + "\014web_entities\030\001"
          + " \003(\0132..google.cloud.vision.v1.WebDetection.WebEntity\022K\n"
          + "\024full_matching_images\030\002"
          + " \003(\0132-.google.cloud.vision.v1.WebDetection.WebImage\022N\n"
          + "\027partial_matching_images\030\003"
          + " \003(\0132-.google.cloud.vision.v1.WebDetection.WebImage\022P\n"
          + "\032pages_with_matching_images\030\004"
          + " \003(\0132,.google.cloud.vision.v1.WebDetection.WebPage\022N\n"
          + "\027visually_similar_images\030\006"
          + " \003(\0132-.google.cloud.vision.v1.WebDetection.WebImage\022H\n"
          + "\021best_guess_labels\030\010"
          + " \003(\0132-.google.cloud.vision.v1.WebDetection.WebLabel\032B\n"
          + "\tWebEntity\022\021\n"
          ...
          + " \003(\0132-.google.cloud.vision.v1.WebDetection.WebImage\0320\n"
          + "\010WebLabel\022\r\n"
          + "\005label\030\001 \001(\t\022\025\n\r"
          + "language_code\030\002 \001(\tBy\n"
          + "\032com.google.cloud.vision.v1B\021WebDetectionPro"
          + "toP\001Z<google.golang.org/genproto/googlea"
          + "pis/cloud/vision/v1;vision\370\001\001\242\002\004GCVNb\006proto3"
    };
    descriptor =
